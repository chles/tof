/**
 * -
 * TOF (TRUE or FALSE) return only booleans from tests
 * @version v0.1
 * @author Chles
 * @copyright ©2017 Chles
		...
		const tof = {
				...
				_array: {
						...
						is: {
								...
								*/
								...
								intersect: (a,b,v) => tof._array.is.in(a,v) && tof._array.is.in(b,v),
								uniq: function(a,v){
										if(!itof._array.is.in(a,v))
											return;
				...
				*/
				_device: {
						...
						is: {
								mobile: d => (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i).test(navigator.userAgent),
								touch: d => 'ontouchstart' in window,
								retina: d => (window.devicePixelRatio > 1 || (window.matchMedia && window.matchMedia(is.mediaQueryRetina).matches)),
						},
				},
				...
				*/
				_browser: {
						...
						is: {
								 ...
								 * @param {String} b
								*/
								value: b => tof._vars.are.equal(b.toLowerCase(),"safari") ? ((tof._browser.ua.indexOf(b.toLowerCase()) > -1) && !tof._browser.is.chrome()) : tof._browser.ua.indexOf(b.toLowerCase()) > -1,
								/**
								 * Check userAgent
								 *
								 * Usage :
								...
								*/
								...
								safari: b => tof._browser.ua.indexOf("safari") > -1 && !tof._browser.is.chrome(),
						...
						support: {
								...
								*/
								...
								CSS: f => !!( (window.CSS && window.CSS.supports) || (tof._browser.is.opera() && window.supportsCSS) ), // could be wrote : 'CSS' in window
								/**
								 ...
								 * @param {String} v
								*/
								CSSRule: (p,v) => (tof._browser.support.CSS() && (((!tof._browser.is.opera() && window.CSS.supports(p,v))) || (tof._browser.is.opera() && window.supportsCSS(p)))),
				...
				_browserFeature: {
						...
						notification: {
							...
							is: {
								accepted: g => tof._browser.support.notifications() && Notification.permission === "granted",
								refused: g => tof._browser.support.notifications() && Notification.permission === "denied",
							}
